...
```
yt-dlp -a "LifeCicles/Assets/Audio/Soundwave/list.txt" -f b -i -o "LifeCicles/Assets/Themes/Audio/Soundwave/%(title)s_%(autonumber)03d.%(ext)s", "-f b -i -o", é usado em vez de "-f best -i -o", para evitar erros de merge na console.
