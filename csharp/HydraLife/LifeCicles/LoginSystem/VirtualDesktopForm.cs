...
namespace LifeCicles.LoginSystem
{
        ...
        public class DimmedColorTable : ProfessionalColorTable
    {
            ...
            fadeTimer.Tick += (s, args) =>
            {
                ...
                if (this.Opacity <= 0)
                {
                    ...
                    if (trayIcon == null)
                    {
                        ...
                        trayIcon.Icon = Icon.FromHandle(Properties.Resources.hydra1.GetHicon());
        ...
        private void SetupUserBadge()
        {
            ...
            userPic.Image = Properties.Resources.img1;
        ...
        {
            pictureBoxUser.BackgroundImage = Properties.Resources.img1;
        ...
        {
            this.BackgroundImage = Properties.Resources.material1;
            this.panelContent.BackColor = Color.Transparent;
            this.panelContent.BackgroundImage = Properties.Resources.material1;
